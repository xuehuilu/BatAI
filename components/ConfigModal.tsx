        ...
        >
            ...
            >
                <header className="p-6 border-b border-gray-200 flex justify-between items-center">
                    <h3 className="text-xl font-semibold text-gray-800">Configure {source.name}</h3>
                ...
                <div className="p-6 overflow-y-auto">
                    <div className="space-y-5">
                        <div>
                            <label className="text-sm font-medium text-gray-700 mb-1 block">Endpoint</label>
                        ...
                        <div>
                            <label className="text-sm font-medium text-gray-700 mb-1 block">Access Key ID</label>
                        ...
                        <div>
                            <label className="text-sm font-medium text-gray-700 mb-1 block">Access Key Secret</label>
                    ...
                    {testStatus === 'success' && (
                        <div className="mt-4 p-3 bg-green-50 text-green-700 border border-green-200 rounded-md text-sm">
                            ✅ Connection successful! Found access.log data.
                        </div>
                    )}
                     {testStatus === 'error' && (
